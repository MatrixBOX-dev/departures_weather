...
active_station = "1"        # station slot currently on screen
cycle_timer = time.monotonic()
wx_code = None              # cached open-meteo weather code
wx_temp = ""                # cached current temperature, number only
wx_peak = None              # today's high while it is still ahead
wx_timer = 0
timer = ""
